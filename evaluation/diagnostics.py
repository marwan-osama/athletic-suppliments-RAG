...
_RETRIEVER_RECALL_SUGGESTIONS = [
    ...
    "Add a query-expansion step: use the LLM to generate synonyms and "
    "related medical terms before searching.",
]
...
class DiagnosticEngine:
    ...
    def run(self, eval_result: EvalResult, use_llm: bool = True) -> DiagnosticReport:
